...
<head>
    ...
    <title>Editar categoría | Fastpack</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $query = "SELECT * FROM categorias WHERE id='$registro_id' ";
                                ...
                                ?>
                                        ...
                                        <form action="codecategorias.php" method="POST">
                                            <input type="hidden" name="id" value="<?= $registro['id']; ?>">

                                            <div class="row mt-1">
                                                <div class="form-floating col-12">
                                                    <input type="text" class="form-control" name="categoria" id="categoria" value="<?= $registro['categoria']; ?>">
