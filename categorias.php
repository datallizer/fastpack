...
<head>
    ...
    <title>Categorías | Fastpack</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 style="color:#fff" class="m-1">CATEGORÍAS
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editarcategoria.php?id=<?= $registro['id']; ?>" class="btn btn-warning btn-sm m-1"><i class="bi bi-pencil-square"></i></a>

                                                        <form action="codecategorias.php" method="POST" class="d-inline">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="codecategorias.php" method="POST" class="row">
                        <div class="col-12 col-md-12 form-floating mb-3">
                            <input type="text" class="form-control" name="categoria" id="categoria" placeholder="Categoría" autocomplete="off" required>
